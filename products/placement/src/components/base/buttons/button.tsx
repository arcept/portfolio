...
export const styles = sortCx({
    ...
    colors: {
        // The full-page primary action color, confirmed against reference screens (Apply Now, View
        // Form, Browse Jobs, Accept Now) — Figma's "Gray Cool 900", not the Purple brand color.
        primary: {
            root: [
                "bg-[var(--color-gray-cool-900)] text-white shadow-xs-skeuomorphic ring-1 ring-transparent ring-inset hover:opacity-90 data-loading:opacity-90",
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                "*:data-icon:text-white/60 hover:*:data-icon:text-white/70",
            ].join(" "),
        },
        // Purple brand — reserved for modals/popups (Confirm Apply, Go to Placement Hub,
        // offer-accepted flow), per docs/placement/spec/screens verification, not full-page CTAs.
        brand: {
            root: [
