...
// The About page's theme switch. One shape does both states: a disc that is a sun with rays out, and
// becomes a moon when a second disc slides in and craters it. The knob travels on a spring and
// squashes while it is held, so the control has some give.
//
// It also owns keeping <html> in step: on client-side navigations the inline gate script doesn't run,
// and the attribute is removed on unmount so the choice does not leak onto the rest of the site.
...
export default function AboutThemeSwitch() {
  ...
  return (
    ...
    >
      ...
      <span className="abt-switch__end abt-switch__end--sun" aria-hidden="true">
      ...
      <span className="abt-switch__end abt-switch__end--moon" aria-hidden="true">
        <svg viewBox="0 0 24 24" fill="none">
      ...
      >
        <svg viewBox="0 0 24 24" className="abt-switch__glyph">
          <defs>
            <mask id="abt-moon-mask">
